...
var chatbox = new (alt1_chatbox__WEBPACK_IMPORTED_MODULE_4___default())();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("https://18.169.241.92:8080/send_webhook", {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                ...
                case 3:
                    ...
                    return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("https://18.169.241.92:8080/clear_event_timer", {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                "Origin": document.location.href,
...
if (window.alt1) {
    ...
    document.querySelector('#mainTab p').innerHTML = "Alt1 not detected, click <a href='".concat(addappurl, "'>here</a> to add this app to Alt1.");
}
// Handle RuneScape game window focus and blur events using Alt1 API
alt1__WEBPACK_IMPORTED_MODULE_5__.on("rsfocus", function () {
